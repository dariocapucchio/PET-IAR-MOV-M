...
La placa maestro funciona como una interfaz entre un servidor MQTT y las placas esclavo (*[firmware](https://github.com/dariocapucchio/PET-IAR-MOV-S.git)*) que controlan los motores. La cominicación con el servidor de MQTT se realiza vía ethernet para publicar y recibir los datos de control del movimiento de la antena. Y la comunicación con las placas esclavo se raliza vía I2C. 
